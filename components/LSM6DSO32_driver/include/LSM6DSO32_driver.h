...
#define LSM6DS_CTRL2_G_GYRO_FS_125_DPS		(1 << 2)
#define LSM6DS_CTRL2_G_GYRO_FS_250_DPS		(0 << 3)
#define LSM6DS_CTRL2_G_GYRO_FS_500_DPS		(1 << 3)
#define LSM6DS_CTRL2_G_GYRO_FS_1000_DPS		(2 << 3)
#define LSM6DS_CTRL2_G_GYRO_FS_2000_DPS		(3 << 3)
