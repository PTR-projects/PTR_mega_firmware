 ...
 */
typedef struct {
	float h;			/*!< The estimated altitude. */
	float v;			/*!< The estimated vertical velocity. */
	float P[2][2];		/*!< The error covariance matrix. */
	float Q_accel;		/*!< The process noise variance for acceleration. */
	float R_altitude;	/*!< The measurement noise variance for altitude. */
} KF_AltitudeAscent_t;
