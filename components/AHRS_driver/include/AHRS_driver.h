...
typedef union {
	struct{
		...
		float yaw;		/*!< Yaw angle (in degree). */
	};
	struct{
		float tilt;		/*!< Tilt angle (in degree). */
...
/**
 * @brief Updates the reference pressure for the AHRS module.
 * @param[in] press The reference pressure to set.
 */
