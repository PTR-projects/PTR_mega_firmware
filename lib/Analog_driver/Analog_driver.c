...
// extern const uint8_t ulp_main_bin_start[] asm("_binary_ulp_main_ulp_adc_bin_start");
// extern const uint8_t ulp_main_bin_end[]   asm("_binary_ulp_main_ulp_adc_bin_end");
...
//	ESP_LOGI(TAG, "ADC ULP init done");
	...
	// uint32_t cal_val = get_calibration_offset(ADC_UNIT_1, ADC_CHANNELS[0]);
